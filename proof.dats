...
datasort avltree_t (key, value, int) = 	
| AVLNil (key, value, 0) of ()
| {hl,hr:nat | ~1 <= hl-hr; hl-hr <= 1} 
  AVLNode (key, value, 1 + max (hl, hr)) of (key, value, avltree_t (key, value, hl), avltree_t (key, value, hr))
 *)
...
datasort avltree = 
| AVL_l of ()
| AVL_n of (avltree ,avltree)

dataprop avlheight (avltree, int) = 
| avlheight_l (AVL_l (), 0) of ()
| {t1,t2:avltree}{n1,n2:nat}
  avlheight_n (AVL_n (t1,t2), max (n1, n2)+1) of (avlheight(t1, n1), avlheight(t2, n2))

dataprop avlsize (avltree, int) = 
| avlsize_l (AVL_l (), 0) of ()
| {t1,t2:avltree}{n1,n2:nat}
  avlsize_n (AVL_n (t1, t2), n1+n2+1) of (avlsize(t1, n1), avlsize(t2, n2))

dataprop avlshortestpath (avltree, int) =
| avlshortestpath_l (AVL_l (), 0) of ()
| {t1,t2:avltree}{n1,n2:nat}
  avlshortestpath_n (AVL_n (t1, t2), min (n1, n2)+1) of (avlshortestpath(t1, n1), avlshortestpath(t2, n2))

prfun avlheight_isfun {t:avltree}{n1,n2:nat} .<t>.
(
  pf1: avlheight(t,n1), pf2:avlheight(t,n2)
): [n1==n2] void = 
case+ (pf1, pf2) of 
| (avlheight_l (), avlheight_l ()) => ()
| (avlheight_n (pf11, pf12), avlheight_n (pf21, pf22)) => let
...
prfun avlsize_isfun {t:avltree}{n1,n2:nat} .<t>. 
(
  pf1:avlsize(t, n1), pf2:avlsize(t, n2)
): [n1==n2] void = 
case+ (pf1, pf2) of 
| (avlsize_l (), avlsize_l ()) => ()
| (avlsize_n (pf11, pf12), avlsize_n (pf21, pf22)) => let 
...
prfun avlshortestpath_isfun {t:avltree}{n1,n2:nat} .<t>.
(
  pf1:avlshortestpath(t, n1), pf2:avlshortestpath(t, n2)
): [n1==n2] void = 
case+ (pf1, pf2) of 
| (avlshortestpath_l (), avlshortestpath_l ()) => ()
| (avlshortestpath_n (pf11, pf12), avlshortestpath_n (pf21, pf22)) => let 
